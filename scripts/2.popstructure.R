...
#   UL < 0 & LL < 0 ~ "significant" ))
# 
# pairwise.fst.males <- pairwise.fst.males %>% mutate(Sig = case_when(
#   UL > 0 & LL > 0 ~ "",
#   UL > 0 & LL < 0 ~ "NS",
#   UL < 0 & LL < 0 ~ "" ))
# 
...
#   UL < 0 & LL < 0 ~ "significant" ))
# 
# pairwise.fst.females <- pairwise.fst.females %>% mutate(Sig = case_when(
#   UL > 0 & LL > 0 ~ "",
#   UL > 0 & LL < 0 ~ "NS",
#   UL < 0 & LL < 0 ~ "" ))
# 
...
#   UL < 0 & LL < 0 ~ "significant" ))
# 
# pairwise.fst.chicks <- pairwise.fst.chicks %>% mutate(Sig = case_when(
#   UL > 0 & LL > 0 ~ "",
#   UL > 0 & LL < 0 ~ "NS",
#   UL < 0 & LL < 0 ~ "" ))
# 
