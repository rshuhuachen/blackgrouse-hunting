...
library(hierfstat)
 ...
 # adults <- read.table("data/rawdata/Microsat.adults.forstructure.stru")
 # unrchicks <- read.table("data/rawdata/Microsat.unrelated.chicks.forstructure.stru")
 # names(unrchicks) <- names(adults)
 # all <- rbind(adults, unrchicks)
 # write.table(all, "data/rawdata/Microsat.adults.plus.unrelated.chicks.forstructure.stru", sep = " ", quote=F, col.names = F, row.names = F)
